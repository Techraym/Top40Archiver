...
def build_predictions(range_key: str = "24h") -> dict[str, Any]:
    ...
    throughput_per_hour = max(1.0, 18.0 / max(1, workers))
    if failed_change > 0:
        throughput_per_hour *= 0.65
    ...
    if highest["risk"] >= 70:
        ...
        advice = "Laat downloads gepauzeerd of op één worker draaien en controleer de live logs voordat de wachtrij wordt hervat."
        ...
        advice = "Behoud de huidige rustige downloadinstellingen en blijf de 24-uurs trend volgen."
