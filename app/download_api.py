...
:root{--bg:#f4f5f7;--card:#fff;--ink:#1f2933;--muted:#67727e;--line:#dfe3e8;--good:#147a48;--warn:#a26700;--bad:#b42318}*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--ink);font:14px/1.45 system-ui,sans-serif}.shell{max-width:1500px;margin:auto;padding:24px}header{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;margin-bottom:18px}.nav{display:flex;gap:8px;flex-wrap:wrap}.nav a{color:var(--ink);text-decoration:none;background:#fff;border:1px solid var(--line);padding:8px 11px;border-radius:999px}.metrics,.providers{display:grid;gap:12px}.metrics{grid-template-columns:repeat(4,minmax(0,1fr));margin-bottom:16px}.metric,.provider,.jobs{background:var(--card);border:1px solid var(--line);border-radius:18px;padding:16px}.metric b{font-size:28px;display:block}.metric span{color:var(--muted)}.providers{grid-template-columns:repeat(3,minmax(0,1fr))}.provider h2{margin:0 0 5px}.muted{color:var(--muted)}.good{color:var(--good)}.warn{color:var(--warn)}.bad{color:var(--bad)}button{font:inherit;border:1px solid var(--line);background:#fff;border-radius:10px;padding:7px 10px;cursor:pointer}.row{display:flex;justify-content:space-between;gap:10px;border-top:1px solid var(--line);padding:8px 0}.jobs{margin-top:16px;overflow:auto}table{width:100%;border-collapse:collapse;min-width:800px}th,td{text-align:left;padding:8px;border-bottom:1px solid var(--line);vertical-align:top}@media(max-width:900px){.metrics{grid-template-columns:repeat(2,1fr)}.providers{grid-template-columns:1fr}}@media(max-width:520px){.metrics{grid-template-columns:1fr}.shell{padding:12px}header{flex-direction:column}}</style></head><body><main class='shell'><header><div><h1>Download Providers</h1><p class='muted'>Multi Source Download Engine · YouTube Music en YouTube zijn fallbackproviders.</p></div><div class='nav'><a href='/'>AI Control Room</a><a href='/ai-session'>Qwen AI Session</a></div></header><section class='metrics' id='metrics'></section><section class='providers' id='providers'></section><section class='jobs'><h2>Recente jobs</h2><div id='jobs'>Laden…</div></section></main><script>
