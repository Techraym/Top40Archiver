...
def run_cycle() -> dict:
    ...
    # Uitgestelde acties worden bij iedere cyclus opnieuw beoordeeld. Daardoor
    # beïnvloedt het echte resultaat meteen de volgende beslissing; er is geen
    # minimumleeftijd of 7-daagse wachtdrempel voor leren.
    ...
    # Code-self-healing draait na de gewone operations-acties. Alleen geobserveerde
    # runtimefouten kunnen een patch starten; productiepromotie vereist sandboxtests,
    # een geverifieerde versiebackup en een canary met automatische rollback.
    ...
    actions_executed = (
        ...
        + (1 if code_report.get("action") not in {"none", "cooldown", "verify_existing_patch"} else 0)
    )
    ...
    # Het venster blijft 7 dagen voor trendrapportage, maar beslissingen en leren
    # beginnen vanaf de allereerste actie en readiness wacht niet op kalenderdagen.
