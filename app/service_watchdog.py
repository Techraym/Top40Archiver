...
SERVICE_POLICIES: dict[str, dict[str, Any]] = {
    ...
    "top40-archiver-check.timer": {"group": "database", "kind": "timer", "required": True, "repair_action": "repair_check_timer"},
    ...
    "top40-archiver-check.service": {"group": "database", "kind": "oneshot", "required": True, "paired_timer": "top40-archiver-check.timer"},
